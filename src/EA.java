...
public class EA{	
	public static void main(String args[]) throws IOException {
    	...
    	String[] HEADERS = {"scientificName", "Other scientific names", "stateCommonName", "Form type", "1.1 score", "1.2 score", "1.3 score", "1.4 score"};
	...
	public static void extract(String filePath, CSVPrinter printer) throws IOException {
        ...
        int n = 3; if(text.indexOf("1.4. Impact") != -1) n++;
        
        /*we get the scores for 1.1, 1.2, 1.3 and 1.4 if that exists
        	blanks and "U"'s are represented as a 0*/
        for(int i = 1; i <= n; i++) {
	        ...
	        if(temp.equals("U")) scores[i] = 0;
	        else if(temp.equals("")) scores[i] = 0;
	        else scores[i] = Integer.parseInt(temp)/10.0;
        }
                	        
        //print data to csv
  	    printer.printRecord(scientificName, otherScientificName, commonNames, formType, scores[1], scores[2], scores[3], scores[4]);
