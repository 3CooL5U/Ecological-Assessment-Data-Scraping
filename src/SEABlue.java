...
public class SEABlue {
	...
	public static void main(String args[]) throws IOException {
		...
		// "stateCommonName", "Hum_health_pos",
		// "Hum_health_neg", "Ind1_ag_pos", "Ind2_for_pos", "Ind1_ag_neg",
		// "Ind2_for_neg", "Soc_rec_pos", "Soc_rec_neg"};
	...
	public static void check(String filePath, CSVPrinter printer) throws IOException {
		...
		String otherScientificName = text.substring(text.indexOf("Scientific Name:") + 16, text.indexOf("Common Name:"))
				.trim();
		String commonNames = text.substring(text.indexOf("Common Name:") + 13, text.indexOf("Native Distribution:"))
				.trim();
	...
	public static void extract(String filePath, CSVPrinter printer) throws IOException {
		...
		scores[6] = scores[6] / 15.0;
		scores[7] = scores[7] / 15.0;
		double pos = scores[3] / 70.0;
		double neg = scores[4] / 70.0;
		for (int i = 2; i <= 5; i++)
			scores[i] = 0;
